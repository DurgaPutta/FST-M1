...
public class Activity7 {
	...
	public void uiScrollableTest() {
		...
		//wait.until(ExpectedConditions.visibilityOfElementLocated(AppiumBy.xpath("/android.widget.Image[@text=\"Ade\"])")));
		...
		.androidUIAutomator(UiScrollable + ".scrollForward(20).getChildByText(className(\"android.widget.Image\"), \"Helen\")"))
		.getText();
